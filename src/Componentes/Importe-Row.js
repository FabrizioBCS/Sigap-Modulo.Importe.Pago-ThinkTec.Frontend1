...
class ImporteRow extends React.Component {
  ...
  render() {
    ...
    */}
        <td className="td" id={"numeros" + (this.props.numero + 1)} style={{display: 'none'}}>
          {this.props.numero + 1}
        </td>

        <td className="td_" id={"ciclo" + (this.props.numero + 1)}>
          <form action="#" >
            <label className="center-xs color_white">{this.props.pago.ciclo}</label>
          </form>
        </td>

        <td className="td" id={"numConceptos" + (this.props.numero + 1)}>
           <form action="#">
            <label className="row center-xs color_white">{this.props.pago.concepto}</label>
        ...
        <td className="td" id={"recibos" + (this.props.numero + 1)}>
          <form action="#">
            <label className="center-xs color_white">{this.props.pago.numero}</label>
          </form>
        </td>
