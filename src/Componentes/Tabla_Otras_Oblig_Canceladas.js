...
import TablaBodyObligCanceladas from './Tabla_Body_Oblig_Canceladas';
class TablaOtrasObligCanceladas extends React.Component {
...
<table>
        ...
        <tr >
            <th className="thLabel">OTRAS OBLIGACIONES CANCELADAS</th>
        </tr>
    ...
    <tbody>
...

        {
            this.props.otrasObligaciones.map((data) => {
              return <TablaBodyObligCanceladas data={data} codAlumno={this.props.codAlumno} codPrograma={this.props.codPrograma} dataConcepto={this.props.dataConcepto} conceptoVL={this.props.conceptoVL} dataMoneda={this.props.dataMoneda} monedaVL ={this.props.monedaVL} />
            })
          }
...
export default TablaOtrasObligCanceladas